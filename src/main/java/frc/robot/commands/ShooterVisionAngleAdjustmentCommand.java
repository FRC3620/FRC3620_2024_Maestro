...
public class ShooterVisionAngleAdjustmentCommand extends Command {
  ...
  public ShooterVisionAngleAdjustmentCommand(VisionSubsystem vision, ShooterElevationSubsystem shooter) {
    // Use addRequirements() here to declare subsystem dependencies.
    this.visionSubsystem = vision;
    this.shooterElevationSubsystem = shooter;
  ...
  public void execute() {
    ...
    if(distance == null){
      ...
      if( visionSubsystem.getCamYawToSpeaker() != null) {
