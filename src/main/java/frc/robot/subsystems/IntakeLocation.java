...
public class IntakeLocation {
    ...
    public static IntakeLocation midGroundPositionForHome = new IntakeLocation(30,12, 0);
    public static IntakeLocation homePosition = new IntakeLocation(1.84, 1, 0);//0, 0, 5.71);
